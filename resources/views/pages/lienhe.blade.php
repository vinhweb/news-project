        ...
        <div class="col-md-9">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="break"></div>
                    <h4>
                        <span class="glyphicon glyphicon-home "></span> Địa chỉ : </h4>
                    <p>90-92 Lê Thị Riêng, Quận 1, Bến Thành, HCM </p>

                    <h4>
                        <span class="glyphicon glyphicon-envelope"></span> Email : </h4>
                    <p>90-92 Lê Thị Riêng, Quận 1, Bến Thành, HCM </p>

                    <h4>
                        <span class="glyphicon glyphicon-phone-alt"></span> Điện thoại : </h4>
                    <p>90-92 Lê Thị Riêng, Quận 1, Bến Thành, HCM </p>
                    ...
                    <br>
                    <h3>
                        <span class="glyphicon glyphicon-globe"></span> Bản đồ</h3>
                    <div class="break"></div>
                    <br>
